  ...
  render() {
    return html`
      <div id="header">
        ...
        <div id="buttons">
          <button id="load" title="Lade Datenbank von lokaler Platte" class="blue-button" @click="${this._load}">Lade</button>
          <button id="save" title="Speichere Datenbank auf lokale Platte" class="blue-button" @click="${this._save}">Speicher</button>
          <button id="zip" title="Erzeuge verschlüsseltes Zip-Archiv" class="blue-button" @click="${this._zip}">Zip</button>
        </div>
      </div>
      <div id="record-list">  
