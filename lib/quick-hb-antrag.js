...
export class QuickHbAntrag extends LitElement {
    ...
    get structure() {
        return this.structureEditor?.structure || ['Antrag'];
    }
    ...
    render() {
        ...
        return html`
            ...
            <structure-editor id="editor-structure" .database=${this.database} label="Gliederung" @structure-change="${this._structureChange}"></structure-editor>
